...
class RefundCancelOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $model = Order::query()->with('customer')->whereIn('status', [OrderStatus::Refund->value, OrderStatus::Canceled->value]);
        ...
        return view("dashboard.refund-cancel-orders.index");
    }
