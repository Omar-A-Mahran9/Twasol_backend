...
var KTDatatablesServerSide = function () {
    let dbTable = 'fast-shipping-city';
    // Private functions
    var initDatatable = function () {
        ...
        datatable.on('draw', function () {
            ...
            deleteAndRestoreRowWithURL(`/dashboard/${dbTable}/`, `/dashboard/${dbTable}/restore/`);
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                $("#shipping_price_inp").val(data.shipping_price);
                $("#city_id_inp").val(data.city_id).change();
