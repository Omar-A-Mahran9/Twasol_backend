            ...
            columnDefs: [
                    ...
                    render: function (data) {
                        return `
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" value="${data}" data-item="${__('Offer')}" />
                            </div>`;
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="d-flex align-items-center">
                                <span href="javascript:;" class="mb-1 text-gray-800 text-hover-primary">${row.category.name}</span>
                            </div>`;
                    }
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="d-flex align-items-center">
                                <span href="javascript:;" class="mb-1 text-gray-800 text-hover-primary">${row.vendor.name}</span>
                            </div>`;
                    }
                },
                {
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/offers/${data.id}" class="menu-link px-3 show_button" data-kt-docs-table-filter="show_row">
                                        ${__('Show')}
                                    </a>
                                </div>
                                <!--end::Menu item-->
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                $("#rejection_reason_inp").val(data.rejection_reason);
                $(`[name='category_id']`).val(data.category_id ?? '').attr('selected',true);
                $(`[name='category_id']`).trigger('change');
                $(`[name='vendor_id']`).val(data.vendor_id ?? '').attr('selected',true);
                $(`[name='vendor_id']`).trigger('change');
                $(`[name='status']`).val(data.status ?? '').attr('selected',true);
