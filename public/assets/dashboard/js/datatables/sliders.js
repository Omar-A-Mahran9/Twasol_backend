...
var KTDatatablesServerSide = function () {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a class="text-dark" href="javascript:" onclick="showMoreInDT(this)" > <span title="${__('show more')}" >${data.substr(0, 100)}</span> </a>
                                <span  title="${__('show more')}"> ${data.length > 100 ? '...' : ''} </span>
                                <span  style="display:none"> ${data.substr(100)} </span>`;
                ...
                },
                {
                    ...
                    render: function (data) {
                        if (data == 1) {
                            ...
                            <div>
                                <!--begin::Info-->
                                <span class="badge badge-light-success">${__('Visible')}</span>
                                <!--end::Info-->
                            </div>
                        `;
                        } else {
                            return `
                                <div>
                                    <!--begin::Info-->
                                <span class="badge badge-light-danger">${__('Invisible')}</span>
                                    <!--end::Info-->
                                </div>
                            `;
                        }
                        ...
                        <div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--end::Menu item-->
                                 ...
                                 <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/${dbTable}/${data.id}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        ${__('Show')}
                                    </a>
                                </div>
                                <!--end::Menu item-->
    ...
    //             $(`[name='parent_id']`).val(data.parent_id).attr('selected', true);
