...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        ...
        datatable.on('draw', function () {
            ...
            toggleToolbars();
            handleEditRows();
            deleteRowWithURL(`/vendor/${dbTable}/`);
            // deleteAndRestoreRowWithURL(`/vendor/${dbTable}/`, `/vendor/${dbTable}/restore/`);
            deleteSelectedRowsWithURL({
                url: `/vendor/${dbTable}/delete-selected`,
                restoreUrl: `/vendor/${dbTable}/restore-selected`
            });
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                $("#form_title").text(__('Edit branch'));
                $(`[name='city_id']`).val(data.city.id ?? '').attr('selected', true);
                $(`[name='city_id']`).trigger('change');
                $("#crud_form").attr('action', `/vendor/${dbTable}/${data.id}`);
