...
var productItems = function (response) {
    ...
    productCards = `
        ...
        <div class="col-md-6 col-xxl-4">
            <!--begin::Card-->
            <div class="card special" style="height: 100%;">
                <!--begin::Card body-->
                <div class="card-body d-flex flex-center flex-column">
                    <!--begin::Button-->
                    <a href="/vendor/products/create" class="btn btn-clear d-flex flex-column flex-center">
                        <!--begin::Illustration-->
    ...
    if (Object.keys(products).length > 0) {
        ...
        $.each(products, function (index, product) {
            ...
            <div class="col-md-6 col-xl-4" id="card-${product.id}">
                <!--begin::Card-->
                <div class="card special border-hover-primary" style="height: 100%;">
                    <!--begin::Card header-->
                    <div class="card-header border-0 pt-9">
                        ...
                        <div class="card-title m-0">
                            ...
                            <a href="/vendor/products/${product.id}" class="text-gray-900 text-hover-primary fs-2 fw-bold">${product.name}</a>
                            </div>
                            <!--begin::Card toolbar-->
                        ...
                        <div class="card-toolbar">
                            <div class="me-0">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/vendor/products/${product.id}"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/vendor/products/${product.id}/edit"
...
function deleteProduct(params) {
    $('.delete-item').on('click', function (e) {
        ...
        deleteElement('', `/vendor/products/${id}`, () => retrieveProductsFormBackend())
    });
}
