...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="{{ __('JALID admin dashboard') }}" />
                ...
                <div
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form class="form w-100 ajax-form" action="{{ route('admin.login') }}" method="POST"
                            ...
                            <div class="fv-row mb-10" dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                <label for="email_inp"
                                    class="form-label fs-6 fw-bolder text-dark">{{ __('Email') }}</label>
                                <div class="position-relative mb-3">
                                    <input class="form-control form-control-lg form-control-solid ps-12" type="text"
                            ...
                            <div class="fv-row mb-6" dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                <label for="password_inp"
                                    class="form-label fs-6 fw-bolder text-dark">{{ __('Password') }}</label>
                                <div class="position-relative mb-3" data-kt-password-meter="true">
                                    <input class="form-control form-control-lg form-control-solid ps-12" type="password"
