...
@section('content')
    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Ads list') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search for ads') }}">
                </div>
                <!--end::Search-->
                <!--begin::Toolbar-->
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.ads.store') }}" method="post"
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add new ad') }}</h5>
                        <!--begin::Close-->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            <label class="form-label fs-6 fw-bold mb-3">{{ __('Vendor') }}</label>
                            <select class="form-select form-select" data-control="select2" name="vendor_id"
                        ...
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            <label class="form-label fs-6 fw-bold mb-3">{{ __('Title in Arabic') }}</label>
                            <textarea class="form-control  form-control-lg form-control-solid" name="title_ar" id="title_ar_inp"
                                data-kt-autosize="true"></textarea>
                            <div class="fv-plugins-message-container invalid-feedback" id="title_ar"></div>
                        </div>
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            <label class="form-label fs-6 fw-bold mb-3">{{ __('Title in English') }}</label>
                            <textarea class="form-control  form-control-lg form-control-solid" name="title_en" id="title_en_inp"
                                data-kt-autosize="true"></textarea>
                        ...
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            <label class="form-label fs-6 fw-bold mb-3">{{ __('Link') }}</label>
                            <input class="form-control" name="link" id="link_inp" data-kt-autosize="true">
                            <div class="fv-plugins-message-container invalid-feedback" id="link"></div>
                        </div>
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            <label class="form-label fs-6 fw-bold mb-3">{{ __('Status') }}</label>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/ads.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#add_btn").click(function(e) {
                ...
                $("#crud_form").attr('action', `/dashboard/ads`);
