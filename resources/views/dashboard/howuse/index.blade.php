...
@section('content')
    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('How use list') }}</h3>
            </div>
            <!--end::Card title-->
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.howuse.store') }}" method="post"
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add') }}</h5>
                        <!--begin::Close-->
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/howuse.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#add_btn").click(function(e) {
                e.preventDefault();
                $("#form_title").text(__('Add'));
                $("[name='_method']").remove();
                $("#crud_form").trigger('reset');
                $("#crud_form").attr('action', `/dashboard/howuse`);
