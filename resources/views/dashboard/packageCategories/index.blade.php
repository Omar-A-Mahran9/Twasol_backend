...
@section('content')
            ...
            <div class="card border-hover-primary h-100">
                ...
                <div class="card-header border-0 pt-9">
                    ...
                    <div class="card-title m-0">
                        ...
                        <h4 class="fw-bold me-auto px-4 py-3">{{ __('Packages Categories') }}</h4>
                ...
                <div class="card-body p-9">
                    ...
                    <div class="d-flex  justify-content-between flex-wrap ">
                        ...
                        <div class=" rounded min-w-125px py-1 px-4 me-7">
                            <div class="fs-2 fw-bold">{{ __('packages categories count') }}</div>
                    ...
                    <div class="d-flex justify-content-center flex-wrap mb-5 mt-5">
                        ...
                        <div class="d-flex justify-content-end w-100" id="add_btn" data-bs-toggle="modal"
                            ...
                            <button type="button" class="btn btn-primary w-100" data-bs-toggle="tooltip"
                                ...
                                <!--end::Svg Icon-->{{ __('Add package category') }}
                            </button>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <!--begin::Card title-->
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Packages Categories list') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.packageCategories.store') }}" method="post"
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add new package categories') }}</h5>
                        <!--begin::Close-->
