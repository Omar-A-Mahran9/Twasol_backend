...
@section('content')
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Packages sub Categories list') }}</h3>
            </div>
            <!--end::Card title-->
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex justify-content-end" id="add_btn" data-bs-toggle="modal" data-bs-target="#crud_modal"
                    ...
                    <button type="button" class="btn btn-primary " data-bs-toggle="tooltip"
                        ...
                        <!--end::Svg Icon-->{{ __('Add package sub category') }}
                    </button>
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.packagesubCategories.store') }}" method="post"
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add package sub category') }}</h5>
                        <!--begin::Close-->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fv-row mb-0 fv-plugins-icon-container flex-row-fluid">
                            <label for="package_categories_id_inp"
                                class="form-label required fs-6 fw-bold mb-3">{{ __('Add package category') }}</label>
                            <select class="form-select " data-control="select2" id="package_categories_id_inp"
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/packagesubCategories.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#add_btn").click(function(e) {
                ...
                $("#form_title").text(__('Add package category'));
                $("[name='_method']").remove();
                $("#crud_form").trigger('reset');
                $("#crud_form").attr('action', `/dashboard/packagesubCategories`);
