...
@section('content')
    ...
    <div class="card mb-5 mb-x-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Skin Colors list') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search for skin colors') }}">
                </div>
                <!--end::Search-->
                <!--begin::Toolbar-->
                <div class="d-flex justify-content-end" id="add_btn" data-bs-toggle="modal" data-bs-target="#crud_modal" data-kt-docs-table-toolbar="base">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-original-title="Coming Soon" data-kt-initialized="1">
                        ...
                        <!--end::Svg Icon-->{{ __('Add skin color') }}</button>
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
    ...
    <form id="crud_form" class="ajax-form" action="{{ route('dashboard.skin-colors.store') }}" method="post" data-success-callback="onAjaxSuccess" data-error-callback="onAjaxError">
        @csrf
        <div class="modal fade" tabindex="-1" id="crud_modal">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add new skin color') }}</h5>
                        <!--begin::Close-->
                    ...
                    <div class="modal-body">
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            ...
                            <input type="text" name="name_ar" class="form-control form-control-lg form-control" id="name_ar_inp" placeholder="{{ __('skin color name in arabic') }}" >
                        ...
                        <div class="fv-row mb-2 fv-plugins-icon-container">
                            ...
                            <input type="text" name="name_en" class="form-control form-control-lg form-control" id="name_en_inp" placeholder="{{ __('skin color name in english') }}" >
...
@push('scripts')
    ...
    <script src="{{ asset('assets/dashboard/js/datatables/skin-colors.js') }}"></script>
    ...
    <script>
        $(document).ready(function () {
            $("#add_btn").click(function (e) {
                ...
                $("#form_title").text( __('Add new skin color') );
                $("[name='_method']").remove();
                $("#crud_form").trigger('reset');
                $("#crud_form").attr('action', `/dashboard/skin-colors`);
            });
