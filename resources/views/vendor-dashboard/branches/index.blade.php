...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">{{ __('Branches list') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex justify-content-end" id="add_btn" data-bs-toggle="modal" data-bs-target="#crud_modal"
                    ...
                    <!--begin::Add customer-->
                    <button type="button" class="btn btn-primary" style="background-color: #DEB893"
                        ...
                        <!--end::Svg Icon-->{{ __('Add branch') }}</button>
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
                <div class="d-flex justify-content-end align-items-center d-none" data-kt-docs-table-toolbar="selected">
                    <div class="fw-bold me-5">
                        <span class="me-2" data-kt-docs-table-select="selected_count"></span>{{ __('Selected items') }}
                    </div>
    ...
    {{-- begin::Add Patient Modal --}}
    <form id="crud_form" class="ajax-form " action="{{ route('vendor.branches.store') }}" method="post"
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="form_title">{{ __('Add new branch') }}</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" style="background-color: #DEB893">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/vendor-dashboard/js/datatables/cities.js') }}"></script>
    <script src="{{ asset('assets/vendor-dashboard/js/crud-operations.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#add_btn").click(function(e) {
                ...
                $("#form_title").text(__('Add new branch'));
                $("[name='_method']").remove();
                $(`[name='city_id']`).val('').attr('selected', false);
                $(`[name='city_id']`).trigger('change');
                $("#crud_form").trigger('reset');
                $("#crud_form").attr('action', `/vendor/branches`);
                $("#city_id_inp").select2({
