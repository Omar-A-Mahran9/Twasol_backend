        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-20" placeholder="{{ __('Search for orders') }}">
                    <select class="form-select form-select-solid w-200px ps-40 filter-input ms-2" data-filter-index="3" data-dir="@if(isArabic()) rtl @else ltr @endif" name="status" id="status_inp"
...
@push('scripts')
    ...
    <script src="{{ asset('assets/vendor-dashboard/js/datatables/orders.js') }}"></script>
@endpush
