                    ...
                    <div data-kt-search-element="wrapper">
                            ...
                            <div class="scroll-y mh-200px mh-lg-350px">
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets/vendor-dashboard/media/avatars/300-6.jpg') }}"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets/vendor-dashboard/media/avatars/300-2.jpg') }}"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets/vendor-dashboard/media/avatars/300-9.jpg') }}"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets/vendor-dashboard/media/avatars/300-14.jpg') }}"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-40px me-4">
                                        <img src="{{ asset('assets/vendor-dashboard/media/avatars/300-11.jpg') }}"
                                            alt="" />
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets/vendor-dashboard/media/svg/brand-logos/volicity') }}-9.svg"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets/vendor-dashboard/media/svg/brand-logos/tvit.svg') }}"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets/vendor-dashboard/media/svg/misc/infography.svg') }}"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets/vendor-dashboard/media/svg/brand-logos/leaf.svg') }}"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                        <span class="symbol-label bg-light">
                                            <img class="w-20px h-20px"
                                                src="{{ asset('assets/vendor-dashboard/media/svg/brand-logos/tower.svg') }}"
                                                alt="" />
                                        </span>
                                    </div>
                                    <!--end::Symbol-->
                        ...
                        <div class="" data-kt-search-element="main">
                            ...
                            <div class="d-flex flex-stack fw-semibold mb-4">
                                <!--begin::Label-->
                                <span class="text-muted fs-6 me-2">{{ __('نتائج البحث الأخيرة:') }}</span>
                                <!--end::Label-->
                            </div>
                            <!--end::Heading-->
                        </div>
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="pb-15 fw-semibold">
                                <h3 class="text-gray-600 fs-5 mb-2">{{ __('لا يوجد نتائج ') }}</h3>
                                <div class="text-muted fs-7">
                                    {{ __('يرجى التأكد من كلمات البحث وإعادة المحاولة مرة أخرى') }}</div>
                            </div>
                            <!--end::Message-->
                        </div>
                        <!--end::Empty-->
            ...
            <div class="d-flex align-items-center ms-3 ms-lg-4">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" id="kt_menu"
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <!--end::Title-->
                                <a href="{{ route('vendor.notifications.mark_all_as_read') }}"
                                    ...
                                    @forelse ($allNotifications->take(10)->get() as $notification)
                                        <div class="d-flex flex-stack py-4 notification-item">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--begin::Title-->
                                                <div class="mb-0 me-2">
                                                    <a href="{{ route('vendor.notifications.mark_as_read', $notification->id) }}"
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                    ...
                    <div class="menu-item px-3 my-0">
                        <a href="#"
                            class="menu-link px-3 py-2 {{ setting('theme_mode') == 'light' ? 'active' : '' }}"
                    ...
                    <div class="menu-item px-3 my-0">
                        <a href="#"
                            class="menu-link px-3 py-2 {{ setting('theme_mode') == 'dark' ? 'active' : '' }}"
