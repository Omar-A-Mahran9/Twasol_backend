...
@section('breadcrumbs')
    {{ Breadcrumbs::render('products', __('Create Product')) }}
@endsection
@section('content')
    <!--begin::Card-->
    <div class="card">
        ...
        <div class="card-body" id="card-body">
            ...
            <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                ...
                <!--end::Nav-->
                <!--begin::Form-->
                <form action="{{ route('vendor.products.store') }}" method="POST" novalidate="novalidate"
                                            ...
                                            <select class="form-select form-select-solid" multiple="multiple"
                                                ...
                                                @foreach ($vendorCities as $vendorCity)
                                                    <option
                                                        ...
                                                        @if ($vendorCity->vendor_has_fast_shipping)
                                                            <span class="badge badge-light-primary">(
                                                                {{ __('Fast shipping available') }} )</span>
                                                        @endif
                                                    </option>
                                                @endforeach
                                            </select>
                    ...
                    <div class="d-flex flex-stack pt-15">
                        <!--begin::Wrapper-->
                        <div class="mr-2">
                            <button type="button" class="btn btn-lg btn-primary me-3" data-kt-stepper-action="previous"
                                style="background-color: #DEB893; color: #ffffff">
            ...
            $('#categories_inp').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        const valuesToRemove = $.grep(data, function(value) {
