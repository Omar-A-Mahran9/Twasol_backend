...
@section('breadcrumbs')
    {{ Breadcrumbs::render('products', __('Edit Product')) }}
@endsection
@section('content')
    <!--begin::Card-->
    <div class="card">
        ...
        <div class="card-body" id="card-body">
            ...
            <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                ...
                <!--end::Nav-->
                <!--begin::Form-->
                <form action="{{ route('vendor.products.update', $product) }}" method="POST" novalidate="novalidate"
                                    ...
                                    <div class="d-flex flex-column flex-md-row gap-5">
                                        ...
                                        <div class="fv-row flex-row-fluid" id="cities_div">
                                            ...
                                            <select class="form-select form-select-solid" multiple="multiple"
                                                ...
                                                data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                                @foreach ($vendorCities as $vendorCity)
                                                    <option
                                                        value="{{ $vendorCity->vendor_has_fast_shipping ? json_encode(['id' => $vendorCity->city_id, 'fast_shipping' => $vendorCity->vendor_has_fast_shipping]) : json_encode(['id' => $vendorCity->city_id, 'fast_shipping' => false]) }}"
                                                        @foreach ($product->cities as $productCity) {{ $productCity->id == $vendorCity->city_id ? 'selected' : '' }} @endforeach>
                                                        {{ $vendorCity->city->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <!--end::Select2-->
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="d-flex flex-column flex-md-row gap-5">
                                                                    ...
                                                                    <div class="fv-row flex-row-fluid" id="weight_dev">
                                                                        ...
                                                                        <!--begin::Input-->
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid weight_inp size_inp no-arrow"
                                                                            onchange="handleInputChange()" type="number"
                                                                            step="0.1" name="weight" min="0.1"
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="d-flex flex-column flex-md-row gap-5">
                                                                    ...
                                                                    <div class="fv-row flex-row-fluid" id="weight_dev">
                                                                        ...
                                                                        <!--begin::Input-->
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid weight_inp size_inp"
                                                                            onchange="handleInputChange()" type="number"
                    ...
                    <div class="d-flex flex-stack pt-15">
                        ...
                        <div class="mr-2">
                            <button type="button" class="btn btn-lg btn-light-primary me-3"
                                data-kt-stepper-action="previous" style="background-color: #DEB893; color: #ffffff">
                        ...
                        <div>
                            <button type="button" class="btn btn-lg btn-success me-3" data-kt-stepper-action="submit">
                                <span class="indicator-label" style="color: #ffffff">{{ __('Save') }}</span>
                                <span class="indicator-progress">{{ __('Please wait...') }}
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </button>
                            <button type="button" class="btn btn-lg btn-primary" data-kt-stepper-action="next"
                                style="background-color: #DEB893">{{ __('Next') }}
...
@push('scripts')
    <script>
            ...
            $('#categories_inp').on('change', function() {
                ...
                if (selectedCategoryId == 1) {
                    ...
                    options.forEach(option => {
                        ...
                        opt.value = option.value;
                        opt.textContent = option.text;
                        console.log(caliber, caliber && option.value == caliber)
        ...
        function handleInputChange() {
            ...
            if (selectedCategoryId == 4, selectedCategoryId == 4) {
                $("#add_dev").fadeOut();
            } else {
                $("#add_dev").fadeIn();
            }
            ...
            if (selectedCategory && selectedSubCategory) {
                ...
                if (selectedSubCategoriesTexts[0] === selectedSubCategory.name_ar || selectedSubCategoriesTexts[0] ===
                    ...
                    {{--  console.log(productNameArMainCombination)  --}}
                    if (!productNameArMainCombination.includes(undefined)) {
                        if (caliberSelect.value) {
    ...
    <script>
        function setDropzoneImages(dropzone) {
            $.ajax({
                url: '/vendor/products/{{ $product->id }}/images',
                type: 'GET',
                dataType: 'json',
        ...
        $(document).ready(function() {
            ...
            $('#categories_inp').change(function() {
                ...
                // Make AJAX request
                $.ajax({
                    url: '/vendor/select2-ajax/subcategories',
    ...
    @endif
    <script src="{{ asset('assets/vendor-dashboard/js/forms/products/form-operations.js') }}"></script>
    <script src="{{ asset('assets/vendor-dashboard/js/forms/products/wizzard-form.js') }}"></script>
    <script src="{{ asset('assets/vendor-dashboard/js/components/dropzone.js') }}"></script>
    <script src="{{ asset('assets/vendor-dashboard/js/components/select2-ajax.js') }}"></script>
    <script src="{{ asset('assets/vendor-dashboard/plugins/custom/formrepeater/formrepeater.bundle.js') }}"></script>
    <script>
        $('#variations').repeater({
            initEmpty: false,
