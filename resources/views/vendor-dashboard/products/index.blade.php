...
@section('content')
    <!--begin::Form-->
    <form id="filter-form" action="{{ route('vendor.products.index') }}" method="get">
        @csrf
                ...
                <div class="collapse" id="kt_advanced_search_form">
                    ...
                    <div class="row g-12 mb-5">
                        ...
                        <div class="col-lg-4">
                            ...
                            <!--begin::Select-->
                            <select class="form-select form-select-solid" data-dir="rtl" name="arrange_by" id="arrange_by"
                                data-control="select2" data-placeholder="{{ __('Select sort method') }}"
                        ...
                        <div class="col-lg-4">
                            ...
                            <!--begin::Select-->
                            <select class="form-select form-select-solid" data-dir="rtl" name="status" id="status"
                                data-control="select2" data-placeholder="{{ __('Select sort method') }}"
                                data-allow-clear="true">
                                <option value=""></option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <!--begin::Select-->
                            <select class="form-select form-select-solid" data-dir="rtl" name="tag" id="tag"
                                data-control="select2" data-placeholder="{{ __('Select sort method') }}"
                                data-allow-clear="true">
                                <option value=""></option>
                                @foreach ($tags as $tag)
                    ...
                    <div class="row d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary w-25" style="background-color: #DEB893">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/vendor-dashboard/js/forms/products/index.js') }}"></script>
